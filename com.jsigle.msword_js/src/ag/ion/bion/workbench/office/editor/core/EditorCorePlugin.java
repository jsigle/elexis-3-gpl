...
public class EditorCorePlugin extends Plugin {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    System.out.println("com.jsigle.msword_js: EditorCorePlugin.java: start(BundleContext context):   \"Texterstellung nicht m̦glich - Es konnte keine Verbindung mit einem Textplugin hergestellt werden\"...");
